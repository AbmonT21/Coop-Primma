...
--
-- Table structure for table `tipos_transacciones`
--
...
--
-- Dumping data for table `tipos_transacciones`
--

LOCK TABLES `tipos_transacciones` WRITE;
/*!40000 ALTER TABLE `tipos_transacciones` DISABLE KEYS */;
INSERT INTO `tipos_transacciones` VALUES (1,'pagoAportaciones'),(2,'pagoprestamo'),(3,'retirocuenta'),(4,'depositocuenta');
